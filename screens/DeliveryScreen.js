            ...
            <View className='rounded-t-3xl -mt-12 bg-white relative'>
                ...
                <View style={{ backgroundColor: themeColors.bgColor(0.8)}} className='p-2 flex-row justify-between items-center rounded-full my-5 mx-2'>
                    <View className='p-1 rounded-full' style={{ backgroundColor: `rgba(255, 255, 255, 0.4)`}}>
                        <Image className='h-16 w-16 rounded-full' source={require('../assets/images/deliveryGuy.jpeg')} />
                    </View>
                    <View className='flex-1 ml-3'>
                        <Text className='text-lg font-bold text-white'>Gary Tard</Text>
                        <Text className='font-semibold text-white'>Your runner</Text>
                    </View>
                    <View className='flex-row items-center space-x-3 mr-3'>
                        <TouchableOpacity className='bg-white rounded-full p-2'>
                            <Icon.MessageCircle fill={themeColors.bgColor(1)} strokeWidth={1} stroke={themeColors.bgColor(1)} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => navigation.navigate('Home') } className='bg-white rounded-full p-2'>
